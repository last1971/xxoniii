<template>
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <input required name="name" type="text" class="col-md-8 form-control" v-model="value.article.name" @input="clearErrors"
        ...
        <div class="form-group row">
            ...
            <input required name="short_text" type="text" class="col-md-8 form-control" v-model="value.article.short_text" @input="clearErrors"
        ...
        <html-editor-component class="form-control" v-model="value.article.content" @input="clearErrors"></html-editor-component>
        <div class="form-group row">
            <label for="start" class="col-md-2 col-form-label text-md-right">Начало</label>
            <date-picker-component  name="start"  class="col-md-8 form-control" v-model="start" @input="clearErrors"
        ...
        <div class="form-group row">
            ...
            <date-picker-component name="end" class="col-md-8 form-control" v-model="end" @input="clearErrors"
        ...
        <div class="form-group row">
            ...
            <select required name="place" class="col-md-8 form-control" v-model="value.place" @input="clearErrors"
            ...
            <span class="invalid-feedback col-md-2 text-md-right"
                  v-if="errors.errors !== undefined && errors.errors['place.id'] !== undefined">
                <strong>{{errors.errors['place.id'][0]}}</strong>
            </span>
        </div>
        <div class="form-group row">
            <label for="lector" class="col-md-2 col-form-label text-md-right">Лектор</label>
            <select required name="lector" class="col-md-8 form-control" v-model="value.lector" @input="clearErrors"
        ...
        <div class="form-group row">
            ...
            <input name="web" type="text" class="col-md-8 form-control" v-model="value.web" @input="clearErrors"/>
        </div>
